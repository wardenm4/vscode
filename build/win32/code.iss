...
AppPublisher=Openova
AppPublisherURL=https://github.com/wardenm4/vscode
AppSupportURL=https://github.com/wardenm4/vscode/issues
AppUpdatesURL=https://github.com/wardenm4/opencursor-releases/releases
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=OpenovaSetup
Compression=lzma
